	...
	<section class="wrapper">
	    ...
	    <header class="panel-heading"><s:message code="indoor.title.insert" />
   		...
   		<section class="panel-body">
	        <form role="form" class="form-horizontal adminex-form" id="addID" method="post">
	        	<section class="form-group">
	                <label class="col-lg-3 control-label"><s:message code="indoor.name" /></label>
	                <section class="col-lg-8">
	                    <input type="text" name="nameD" placeholder="<s:message code="indoor.name" />" class="form-control"/>
	                </section>
	            </section>
	            <section class="form-group">
	    ...
	    <header class="panel-heading"><s:message code="outdoor.title.insert" />
   		...
   		<section class="panel-body">
	        <form role="form" class="form-horizontal adminex-form" id="addOD" method="post">
	        	<section class="form-group">
	                <label class="col-lg-3 control-label"><s:message code="outdoor.name" /></label>
	                <section class="col-lg-8">
	                    <input type="text" name="nameD" placeholder="<s:message code="outdoor.name" />" class="form-control"/>
	                </section>
	            </section>
	            <section class="form-group">
	                <label class="col-lg-3 control-label"><s:message code="outdoor.capacity" /></label>
	                <section class="col-lg-8">
	                    <input type="text" name="capD" placeholder="<s:message code="outdoor.capacity" />" class="form-control"/>
	                </section>
	            </section>
	            <section class="form-group">
	                <section class="col-lg-offset-2 col-lg-10">
