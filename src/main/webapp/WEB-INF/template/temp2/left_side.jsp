    ...
    <section class="left-side-inner">
        ...
        <ul class="nav nav-pills nav-stacked custom-nav">
            <li class="active">
           	...
           	<li class="menu-list">
                ...
                <ul class="sub-menu-list">
                    <li><a href="${pageContext.request.contextPath }/indoor"><s:message code="menu.indoor" /></a></li>
                    <li><a href="${pageContext.request.contextPath }/outdoor"><s:message code="menu.outdoor" /></a></li>
                </ul>
            </li>
            ...
            <li class="menu-list">
                ...
                <ul class="sub-menu-list">
                    <li><a href="${pageContext.request.contextPath }/invehicle/data">
                    	<s:message code="menu.invehicle.data"/>
                   	</a></li>
                    <li><a href="${pageContext.request.contextPath }/invehicle/unload">
            ...
            <li class="menu-list">
                ...
                <ul class="sub-menu-list">
                    <li><a href="${pageContext.request.contextPath }/outvehicle/data">
                    	<s:message code="menu.outvehicle.data" />
                   	</a></li>
                    <li><a href="${pageContext.request.contextPath }/outvehicle/load">
